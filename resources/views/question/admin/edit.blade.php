      ...
      <div class="box-body">
         ...
         <form class="form-signin" method="POST" action="{{action('QuestionController@update', encrypt($question->id))}}">
            ...
            <fieldset>
               ...
               <button class="btn btn-warning pull-right"  type="button" data-toggle="modal" data-action="http://localhost:8000/pergunta/{{encrypt($question->id)}}" href="#deleteModal"> Excluir</button>
